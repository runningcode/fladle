...
abstract class ConfigureFulladleTask : DefaultTask() {
     ...
     */
    private fun isExpectedVariantInModule(variantInfo: VariantInfo, config: SerializableModuleConfig): Boolean {
     ...
     */
    private fun isExpectedAbiOutput(output: VariantOutputInfo, config: FladleConfig): Boolean {
 ...
 */
private fun StringBuilder.appendProperty(value: Any?, propertyName: String) {
    if (value != null) {
